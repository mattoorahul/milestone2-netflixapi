...
public class NetflixDAOHibernateImpl implements NetflixDAO {
	...
	public List<Data> findBymovieType(String movieType) {
		...
		// create a query
		Query<Data> theQuery = currentSession.createQuery("from netflix where listed_in like '%" + movieType + "%' ;",
				Data.class);
	...
	public List<Data> findBycountry(String country) {
		...
		// create a query
		Query<Data> theQuery = currentSession.createQuery("from netflix where country ='" + country + "' ;",
				Data.class);
